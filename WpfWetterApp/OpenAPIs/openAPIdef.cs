...
namespace WpfWetterApp
{
    ...
    {
        private string _baseUrl = "https://api.openweathermap.org/data/2.5";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public WebAPI(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <param name="mode">**Mode**. *Example: html*. Determines the format of the response. Possible values are `json`, `xml`, and `html`. If the mode parameter is empty, the format is `json` by default.</param>
        /// <returns>Successful response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<_200> CurrentWeatherDataAsync(string q, string id, string lat, string lon, string zip, Units? units, Lang? lang, Mode? mode)
        {
        ...
        /// <returns>Successful response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<_200> CurrentWeatherDataAsync(string q, string id, string lat, string lon, string zip, Units? units, Lang? lang, Mode? mode, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("&appid=" + Resources.ResourceManager.GetString("Open_Weather_Api_Key"));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<_200>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<string>("Not found response", status_, responseData_, headers_, result_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
